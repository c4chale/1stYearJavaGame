 ...
 * @author chale
 */
public class newLevel_13 extends GameLevel implements ActionListener {
    ...
    public newLevel_13(String fileName) {
                ...
                for(int i=0; i<tokens.length; i++){
                    switch (tokens[i]) {
                        case "0":
                            ...
                            break;
                        case "354":
                            addGround("354",i, lineCount);
                            break;  
                        case "378":
                            addGround("378",i, lineCount);
                            break;
                        case "237":
                            addGround("237",i, lineCount);
                            break;
                        case "238":
                            addGround("238",i, lineCount);
                            break;
                        case "239":
                            addGround("239",i, lineCount);
                            break;
                        case "29":
