 ...
 * @author chale
 */
public class Level_11 extends GameLevel implements ActionListener {
    ...
    public Level_11(String fileName) throws IOException {
                ...
                for(int i=0; i<tokens.length; i++){
                    switch (tokens[i]) {
                        ...
                        case "42":
                            ...
                            break;
                        case "16":
                            addEnemy("goomba", i,lineCount+1);
                            break;
                        case "190": //KoopaTroopa
                            addEnemy("koopaTroopa",i,lineCount+1);
                            break;
                        default:
                            break;
                    }
    ...
    public Vec2 getPositonSecretRoom() {
        Vec2 posRoom;
        posRoom = new Vec2(flag.getBody().getPosition().x+28*2, 10);
    ...
    public Vec2 getPosTeleportRight() {
        Vec2 posExit;
        posExit = new Vec2(this.getPositonSecretRoom().x+11*2,-11);
        return posExit;
    }
    ...
    public Vec2 getPositionExitTeleport() {
        Vec2 exitTeleport;
        exitTeleport = new Vec2(164*2-15, -7);
